# Differentiation From score-tail WAM
...
The shared ingredient is the finite score-tail law and audit discipline. The mechanism, metrics, diagnostics, repairs, figures, and paper framing are token-specific.
