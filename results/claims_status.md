...
## supported_controlled
Token-specific diagnostics detect selected high-N aliasing and physical-validity failures.

Evidence: `results/tail_autopsy.csv`, `figures/figure4_decode_validity_diagnostics.png`, `figures/figure6_alias_atlas.png`

## supported_controlled
Codebook-aware repair and small token-to-real calibration improve the selected tail in the controlled setting.
...
## not_claimed
External benchmark or real-robot validity.
